...
contract TonExchangeDebot is Debot {
    ...
    uint8 constant STATE_SUPPORT_TOKENS        = 2;
    uint8 constant STATE_ALL_ORDERS            = 3;
    uint8 constant STATE_TRADER_ACCOUNT        = 4;
    ...
    function fetch() public override returns (Context[] contexts) {
        contexts.push(Context(STATE_ZERO,
		    "Hello, I'm Exchange Debot.\n", [             
             ActionInstantRun("Enter exchange address", "selectExchange", STATE_CURRENT) , 
        ...
        contexts.push(Context(STATE_MAIN,
		    "", [             
            ActionGoto("List all" , STATE_ZERO),
    ...
    function start() public override {
     ...
     function selectExchange() public {
  //index = index;
